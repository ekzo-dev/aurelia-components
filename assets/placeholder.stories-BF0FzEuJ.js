/* empty css                                *//* empty css                           */import{r as s}from"./iframe-CQr_Z5xa.js";import"./preload-helper-PPVm8Dsz.js";const t={component:s,title:"Bootstrap / Components / Placeholder",render:()=>({template:`<div class="d-flex justify-content-around">
...
</div>`}),argTypes:{size:{control:"select",options:["","sm","lg","xs"]},animation:{control:"select",options:["","glow","wave"]}}},a={args:{size:"",animation:"glow"}},i={render:()=>({template:`<div>
...
</div>`}),args:{size:"",animation:""}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
    size: '',
    animation: 'glow'
  }
...
}`,...i.parameters?.docs?.source}}};const d=["Example","Color"];export{i as Color,a as Example,d as __namedExportsOrder,t as default};
