import{j as t}from"./iframe-CQr_Z5xa.js";import"./preload-helper-PPVm8Dsz.js";const d=["down","up","end","start"],e=["dynamic","static"],r=["end","sm-start","md-start","lg-start","xl-start","xxl-start"],a={title:"Bootstrap / Components / Dropdown",component:t,render:()=>({template:`<div bs-dropdown="direction.bind: direction; center.bind: center">
