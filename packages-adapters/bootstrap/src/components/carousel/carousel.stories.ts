...
export const withCaptionsExample: Story = (args): StoryFnAureliaReturnType => ({
  components: [BsCarouselItem, BsCarouselCaption],
  props: {
    innerHtml: `
    <bs-carousel-item>
...
export const withoutControlsAutomaticExample: Story = (args): StoryFnAureliaReturnType => ({
  components: [BsCarouselItem, BsCarouselCaption],
  template: `
<bs-carousel ride.bind="true" controls.bind="false" indicators.bind="false">
    <bs-carousel-item>
      <svg class="bd-placeholder-img-lg d-block w-100" width="800" height="400" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: First slide" preserveAspectRatio="xMidYMid slice" focusable="false">
          <title>Placeholder</title>
          <rect width="100%" height="100%" fill="#777"></rect>
